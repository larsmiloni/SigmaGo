...
class GoGameGUI:
    def __init__(self, game):
        ...
        self.square_size = 60
        self.board_size = self.game.size * self.square_size # Number of squares * size of square.
        self.screen = pygame.display.set_mode((self.board_size, self.board_size)) # Make the screen the size of the board.
