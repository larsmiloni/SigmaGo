...
from src.ai.cnn_channels import get_states_new
...
def move_files_to_subdirectories(path_name: str):
    """
    Organize SGF files into subdirectories based on size and presence of handicap.

    Args:
        path_name (str): The path to the SGF files.
    """
...
def parse_and_pickle_batches(path_name, batch_size=BATCH_SIZE, games_per_file=GAMES_PER_FILE):
    ...
    Args:
        path_name (str): The path to the SGF files.
        batch_size (int): The number of games to process before pickling.
        games_per_file (int): The number of games per pickle file.
    """
...
if __name__ == "__main__":
    """
    Organize SGF files into subdirectories and process them in batches.
    """
